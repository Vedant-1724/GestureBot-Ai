...
This README documents the full project structure and workflow without embedding the source programs themselves. For the report-style companion document, see `07_docs/project_master_guide.md`.
...
| `07_docs/README.md` | This detailed project README. |
